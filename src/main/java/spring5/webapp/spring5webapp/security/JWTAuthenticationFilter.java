package spring5.webapp.spring5webapp.security;
...
import static spring5.webapp.spring5webapp.constants.SecurityConstants.EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
    	...
    	System.out.println("SUNT IN SUCCESFULL AUTH");
